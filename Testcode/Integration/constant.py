...
#State Threshold
const.PREPARING_GPS_COUNT_THRE= 5###50
const.PREPARING_TIME_THRE = 6#150###60
const.FLYING_FLIGHTPIN_COUNT_THRE = 10#800
const.DROPPING_ACC_COUNT_THRE = 5###50
...
const.MEASURING_SWITCH_COUNT_THRE = 3#1地点での測位回数###20
const.MEASURING_MAX_MEASURING_COUNT_THRE = 2 #=最大測位点-1  6

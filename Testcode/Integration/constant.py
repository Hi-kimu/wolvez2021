...
#閾値
const.GPS_COUNT_LOOP_THRE= 10
const.PREPARING_TIME_LOOP_THRE = 10
const.COUNT_FLIGHTPIN_LOOP_THRE = 10
const.COUNT_ACC_LOOP_THRE = 10
const.RELEASING_TIME_LOOP_THRE = 10
const.PRE_MOTOR_TIME_LOOP_THRE = 2
